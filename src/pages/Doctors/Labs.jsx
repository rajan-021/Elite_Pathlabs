...
const Labs = () => {
  ...
  const {
    ...
    loading,
    error,
  } = useFetchData(`${BASE_URL}/labs?query=${debouncedQuery}`);
    ...
    <>
      <section className="bg-[#fff9ea]">
        <div className="container text-center">
          <h2 className="heading">Find a Lab</h2>
          <div className="max-w-[570px] mx-auto mt-[30px] bg-[#0066ff2c] rounded-md flex items-center justify-between ">
            <input
              ...
              type="search"
              placeholder="Search by labs name or locations"
              value={query}
      ...
      <section>
        <div className="container">
          ...
          {!loading && labs.length === 0 &&
            <h1 className="text-center text-red-700	">Labs not available currently</h1>
          }
        </div>
      </section>
