...
const Profile = ({ doctorData }) => {
  ...
  const updateDoctorHandler = async e => {
    e.preventDefault();
    try {
      const res = await fetch(`${BASE_URL}/doctors/admin/${doctorData._id}`, {
        method: "put",
        headers: {
      ...
      <form>
        ...
        <div className="mb-5">
          <div className="grid grid-cols-3 gap-5 mb-[30px]">
            ...
            <div>
              <p className="form__label">Locations*</p>
              <select
                name="specialization"
              ...
              >
                <option value="">Select</option>
                <option value="surgeon">Ghaziabad</option>
                <option value="neurologist">Delhi</option>
                <option value="dermatologist">Noida</option>
              </select>
            </div>
